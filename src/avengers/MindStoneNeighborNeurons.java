...
public class MindStoneNeighborNeurons {
    ...
    public static void main (String [] args) {
        ...
        int s = StdIn.readInt();
        String[][] n = new String[s][2];
        int i = 0;
        while (i < s) {
            n[i][0] = StdIn.readString();
            i++;
        }
        int mindStone = StdIn.readInt();
        String[][] e = new String[mindStone][2];
        int k = 0;
        while (k < mindStone) {
            String beg = StdIn.readString();
            String sto = StdIn.readString();
            e[k][0] = beg;
            e[k][1] = sto;
        ...
        while (y < mindStone) {
            ...
            if (e[y][1].equals(n[indForStone][0])) {
